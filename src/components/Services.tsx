...
const services = [
  ...
  },
  {
    ...
    items: ["Schedule Tracking", "Site Coordination", "Quality Assurance"],
  },
  {
    n: "03",
    t: "Owner Advocacy",
    d: "Independent representation focused on your interests across quality, cost, contracts, and decision-making.",
    items: ["Contract Negotiation", "Owner Interest Protection", "Guidance & Advisory"],
  },
];
      ...
      <div className="container">
        <div className="grid lg:grid-cols-12 gap-10 items-end mb-16 reveal">
          ...
          <p className="lg:col-span-5 text-primary-foreground/70 leading-relaxed">
            Tailored owner's representation for discerning clients who expect both
            polish and performance — from a single villa to a portfolio of capital
            projects.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-primary-foreground/10 rounded-sm overflow-hidden reveal">
          {services.map((s) => (
            ...
            >
              ...
              <h3 className="mt-10 font-serif text-2xl md:text-3xl text-primary-foreground">
                {s.t}
              </h3>
              <p className="mt-5 text-sm leading-relaxed text-primary-foreground/70">{s.d}</p>
